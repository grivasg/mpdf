...
<head>
    ...
    <link rel="shortcut icon" href="<?= asset('images/pdf.png') ?>" type="image/x-icon">
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark  bg-dark">
        ...
        <div class="container-fluid">
            ...
            <a class="navbar-brand" href="/mpdf">
                <img src="<?= asset('./images/pdf.png') ?>" width="35px'" alt="cit">
            ...
            <div class="collapse navbar-collapse" id="navbarToggler">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0" style="margin: 0;">
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="/mpdf"><i class="bi bi-house-fill me-2"></i>INICIO</a>
                    </li>

                    <div class="nav-item dropdown ">
                        <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown">
                            <i class="bi bi-asterisk"></i> OPCIONES
                        </a>
